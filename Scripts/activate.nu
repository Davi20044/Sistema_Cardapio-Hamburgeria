...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\User\OneDrive\Área de Trabalho\Sistema_Hamburgueria'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\User\OneDrive\Área de Trabalho\Sistema_Hamburgueria\Scripts\deactivate.nu'
